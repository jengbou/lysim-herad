	...
	{
		{
			...
			analysis = new AnalysisOutput("../" + string(runName) + "/Analysis-" + string(runName)+ "_DY10_DX10.txt");
			if(boolTileFiber) {graphsLayer1.push_back(analysis->graphTile);}
			else {graphsLayer1.push_back(analysis->graphFiber);}
			analysis = new AnalysisOutput("../" + string(runName) + "/Analysis-" + string(runName)+ "_DY20_DX20.txt");
			if(boolTileFiber) {graphsLayer1.push_back(analysis->graphTile);}
			else {graphsLayer1.push_back(analysis->graphFiber);}
			analysis = new AnalysisOutput("../" + string(runName) + "/Analysis-" + string(runName)+ "_DY8_DX12.txt");
			if(boolTileFiber) {graphsLayer1.push_back(analysis->graphTile);}
			else {graphsLayer1.push_back(analysis->graphFiber);}
